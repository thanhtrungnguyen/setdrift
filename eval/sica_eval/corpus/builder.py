...
from sica_eval.corpus.fetcher import BugRecord, iter_bug_records
from sica_eval.corpus.labeler import label_bug
from sica_eval.corpus.schemas import BugSource, Corpus, LabeledPrompt, SkillLabel
...
def build_corpus(
    ...
    *,
    ...
    if min_negative_fraction > 0 and _none_fraction(prompts) < min_negative_fraction:
        ...
        from sica_eval.corpus.negative_miner import load_constructed_negatives

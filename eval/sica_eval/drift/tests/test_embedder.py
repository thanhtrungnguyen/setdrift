...
def test_cosine_similarity_self_is_one():
    ...
    from sica_eval.drift.embedder import cosine_similarity
...
def test_compute_drift_index_range():
    ...
    from sica_eval.drift.embedder import compute_drift_index
...
def test_compute_drift_index_rolling_window():
    ...
    from sica_eval.drift.embedder import compute_drift_index, WINDOW_N
...
def test_embedder_checksum_stable_hex():
    ...
    from sica_eval.drift.embedder import embedder_checksum

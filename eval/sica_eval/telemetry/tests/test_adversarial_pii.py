...
"""
from sica_eval.telemetry.tests import adversarial_pii
...
def test_every_category_present_and_clean():
    ...
    r = adversarial_pii.measure_recall(use_deny_list=True)
    expected = {
        "EMAIL", "PHONE", "US_SSN", "CREDIT_CARD", "IP", "AWS_KEY", "GITHUB_TOKEN",
        "OPENAI_KEY", "SLACK_TOKEN", "PRIVATE_KEY", "PERSON", "CUSTOMER_NAME", "JDBC_CREDS",
    }

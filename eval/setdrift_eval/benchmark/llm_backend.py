...
import anthropic  # module-level so the test fixture can patch setdrift_eval.benchmark.llm_backend.anthropic.Anthropic
import openai  # module-level so the test fixture can patch setdrift_eval.benchmark.llm_backend.openai.OpenAI
